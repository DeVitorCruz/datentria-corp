...
export const CARD_ITEM_2: SlideSwiperScreen = {
    id: 1,
    ...
    swiperInput: {
        FLEX_CARD_ITEM: {
            id: 0,
            head: {
                src: 'assets/collection-info/track-collect-2.jpg',
                alt: '',
            } as MediaImg,
            body: [{
                id: 0,
                ...
                text: ['$890.00'],
                customBlockClassNames: 'card-item-2-track-block-body',
            } as TextBox], 
            customClassName: [],
            customBlockClassName: 'card-item-2-track-block',
            imgFlexAddiction: [
                {
                    imgIcon: {
                        type: 'iconAwesome',
