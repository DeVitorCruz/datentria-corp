...
export const CARD_ITEM_3: SlideSwiperScreen = {
    id: 2,
    ...
    swiperInput: {
        FLEX_CARD_ITEM: {
            id: 0,
            head: {
                src: 'assets/collection-info/track-collect-3.jpg',
                alt: '',
            } as MediaImg,
            body: [{
                id: 0,
                ...
                text: ['$890.00'],
                customBlockClassNames: 'card-item-3-track-block-body',
            } as TextBox], 
            customClassName: [],
            customBlockClassName: 'card-item-3-track-block',
            imgFlexAddiction: [
                {
                    imgIcon: {
                        type: 'iconAwesome',
