...
export const SHOP_CARD_5: CardItem = {
    id: 4,
    image: {
    ...
    content: [
        {
            ...
            heading: {
                ...
                achorFlexList: [
                    {
                        id: 0,
                        title: 'Locket' as string,
                        description: 'shop-product-5' as string,
                        ariaLabel: 'shop-product-5' as string,
                        rlink: '/shop/5' as string,
                        switchAbleIcon: { type: 'none' } as IconSwitch,
                    } as AnchorFlexItem,
                ] as AnchorFlexItem[],
            } as FlexHeadingItem,
            text: ['old-price: $50.00', '$40.00'] as string[],
            buttonSection: [
                {
                    id: 0,
            ...
            customBlockClassName: 'shop-card-block-5' as string,
        } as TextBox,
    ] as TextBox[],
    customClassName: ['shop-card-5'] as string[],
    link: '/shop/5' as string,
} as CardItem;