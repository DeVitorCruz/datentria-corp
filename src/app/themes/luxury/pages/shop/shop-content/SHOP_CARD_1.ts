...
import { IconDefinition, faShoppingCart } from "@fortawesome/free-solid-svg-icons";

export const SHOP_CARD_1: CardItem = {
    id: 0,
    image: {
    ...
    content: [
        {
            ...
            heading: {
                ...
                achorFlexList: [
                    {
                        id: 0,
                        title: 'Tiara' as string,
                        description: 'shop-product-1' as string,
                        ariaLabel: 'shop-product-1' as string,
                        rlink: '/shop/1' as string,
                        switchAbleIcon: { type: 'none' } as IconSwitch,
                    } as AnchorFlexItem,
                ] as AnchorFlexItem[],
            } as FlexHeadingItem,
            text: ['old-price: $250.00', '$220.00'] as string[],
            buttonSection: [
                {
                    id: 0,
            ...
            customBlockClassName: 'shop-card-block-1' as string,
        } as TextBox,
    ] as TextBox[],
    customClassName: ['shop-card-1'] as string[],
    link: '/shop/1' as string,
} as CardItem;